...
export default function App() {
  ...
  const handleOnChange = (e) => {
    ...
    const infraction = newInput.includes("Evil Corp.");
    const updatedInput = infraction
      ? newInput.replace("Evil Corp.", "Good Corp.")
      : newInput;
    ...
    setTrackingReports((prevReports) => [
      ...prevReports,
      {
        ...
        employeeInput: infraction ? "Good Corp." : newInput,
